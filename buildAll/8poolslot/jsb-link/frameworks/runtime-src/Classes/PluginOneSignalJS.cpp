...
static bool js_PluginOneSignalJS_PluginOneSignal_setExternalUserId(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        ...
        SE_PRECONDITION2(ok, false, "js_PluginOneSignalJS_PluginOneSignal_setExternalUserId : Error processing arguments");
        sdkbox::PluginOneSignal::setExternalUserId(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
    return false;
}
SE_BIND_FUNC(js_PluginOneSignalJS_PluginOneSignal_setExternalUserId)
...
static bool js_PluginOneSignalJS_PluginOneSignal_setRequiresUserPrivacyConsent(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        bool arg0;
        ok &= seval_to_boolean(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_PluginOneSignalJS_PluginOneSignal_setRequiresUserPrivacyConsent : Error processing arguments");
        sdkbox::PluginOneSignal::setRequiresUserPrivacyConsent(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
    return false;
}
SE_BIND_FUNC(js_PluginOneSignalJS_PluginOneSignal_setRequiresUserPrivacyConsent)

static bool js_PluginOneSignalJS_PluginOneSignal_requiresUserPrivacyConsent(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        bool result = sdkbox::PluginOneSignal::requiresUserPrivacyConsent();
        ok &= boolean_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_PluginOneSignalJS_PluginOneSignal_requiresUserPrivacyConsent : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_PluginOneSignalJS_PluginOneSignal_requiresUserPrivacyConsent)
...
static bool js_PluginOneSignalJS_PluginOneSignal_consentGranted(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        bool arg0;
        ok &= seval_to_boolean(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_PluginOneSignalJS_PluginOneSignal_consentGranted : Error processing arguments");
        sdkbox::PluginOneSignal::consentGranted(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
    return false;
}
SE_BIND_FUNC(js_PluginOneSignalJS_PluginOneSignal_consentGranted)
...
static bool js_PluginOneSignalJS_PluginOneSignal_setGDPR(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        bool arg0;
        ok &= seval_to_boolean(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_PluginOneSignalJS_PluginOneSignal_setGDPR : Error processing arguments");
        sdkbox::PluginOneSignal::setGDPR(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
    return false;
}
SE_BIND_FUNC(js_PluginOneSignalJS_PluginOneSignal_setGDPR)
...
bool js_register_PluginOneSignalJS_PluginOneSignal(se::Object* obj)
{
    ...
    cls->defineStaticFunction("setExternalUserId", _SE(js_PluginOneSignalJS_PluginOneSignal_setExternalUserId));
    cls->defineStaticFunction("postNotification", _SE(js_PluginOneSignalJS_PluginOneSignal_postNotification));
    cls->defineStaticFunction("setRequiresUserPrivacyConsent", _SE(js_PluginOneSignalJS_PluginOneSignal_setRequiresUserPrivacyConsent));
    cls->defineStaticFunction("requiresUserPrivacyConsent", _SE(js_PluginOneSignalJS_PluginOneSignal_requiresUserPrivacyConsent));
    ...
    cls->defineStaticFunction("consentGranted", _SE(js_PluginOneSignalJS_PluginOneSignal_consentGranted));
    ...
    cls->defineStaticFunction("setGDPR", _SE(js_PluginOneSignalJS_PluginOneSignal_setGDPR));
